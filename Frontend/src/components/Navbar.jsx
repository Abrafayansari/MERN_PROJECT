...
<NavLink className={({ isActive }) => isActive ? acitvelink : normallink} to={"/signup"} >Register</NavLink></div>
  ...
  return (
    ...
    <header  className="  shadow-lg bg-black bg-opacity-40 hover:shadow-xl flex fixed top-0 left-0 h-16 p-4 items-center justify-between   w-[100vw]">
      ...
      <div className=" flex   justify-between  gap-x-5 mr-10    md:flex   items-center   ">
        ...
        <NavLink to={"/tour"} className={({ isActive }) => isActive ? acitvelink : normallink}>
          Tour
        </NavLink>
