...
//     },
//   ];
//   var discountedproducts = products.map((item) => {
//     const discount = 0.5;
//     return { ...item, discount: 50, discountedPrice: item.price * discount };
//   });
...
//     if (cartCopy[item.id]) {
//       cart[item.id].qty++;
//       cart[item.id].unitprice = cartCopy[item.id].price * cartCopy[item.id].qty;
//     } else {
//       cartCopy[item.id] = {
//         id: item.id,
//         qty: 1,
...
//                 <span onClick={()=>{
//                    const copyCart={...cart}
//                 if (cartCopy[KeyItem].qty>1) {
//                   cartCopy[KeyItem].qty--
//                 }return
//                 }}>➖ </span>
