...
const Childthree = () => {
  return (
    <div className='  h-[200vh] w-[100%]'>
      <div><h1 className='text-[48px]  ml-[14vw] font-bold text-[#1c262f]'>Tour highlights</h1>
      <p className='text-[#415161] ml-[14vw] w-[60vw] mt-5 text-[20px]'>Would you like to go on a photo tour? Our guides know exactly what you need! The sceneries we have for you are going to make your vacation unforgettable!</p></div>
      <div className='mt-20 flex ml-[14vw] gap-6 text-center'>
        <div>
